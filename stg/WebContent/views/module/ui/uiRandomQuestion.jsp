...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%
    	UiVo vo = (UiVo)request.getAttribute("uiRandomVo");
    %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>UI테스트 랜덤 Training</title>
<script type="text/javascript">
	function answer(){
		...
		document.getElementById('uiNForm').submit();
	}
</script>
</head>
<body>
		...
		<div class="divCenter">
			<div class="divCenter2">
				<form action="/uiTrainigProc.do" method="post" id="uiNForm">
					...
					<button type="button" onclick="location.href='/randomUiTraining.do'">다음문제</button>
