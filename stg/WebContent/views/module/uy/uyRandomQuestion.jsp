...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%
    	UyVo vo = (UyVo)request.getAttribute("uyRandomVo");
    %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>응용SW기초기술활용 랜덤 Training</title>
		...
		<div class="divCenter">
			<div class="divCenter2">
				<form action="/uyTrainigProc.do" method="post" id="uyNForm">
					...
					<button type="button" onclick="location.href='/randomUyTraining.do'">다음문제</button>
