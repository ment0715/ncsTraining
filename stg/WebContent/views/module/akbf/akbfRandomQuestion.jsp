...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%
    	AkbfVo vo = (AkbfVo)request.getAttribute("akbfRandomVo");
    %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>애플리케이션배포 랜덤 Training</title>
<script type="text/javascript">
	function answer(){
		...
		document.getElementById('akbfNForm').submit();
	}
</script>
</head>
<body>
		...
		<div class="divCenter">
			<div class="divCenter2">
				<form action="/akbfTrainigProc.do" method="post" id="akbfNForm">
					...
					<button type="button" onclick="location.href='/randomAkbfTraining.do'">다음문제</button>
